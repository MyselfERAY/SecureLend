...
export const metadata: Metadata = {
  ...
  description: 'Kira Güvence çerez politikası. Web sitemizde kullanılan çerezler hakkında bilgi.',
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        <h1 className="animate-fade-up font-display text-3xl font-extrabold tracking-tight text-slate-900 mb-8">Çerez Politikası</h1>
