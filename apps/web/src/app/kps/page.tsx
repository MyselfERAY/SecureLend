...
export const metadata: Metadata = {
  ...
  description:
    'KPS (Kimlik Paylasim Sistemi) uzerinden TCKN bazli kimlik dogrulama. Kira Güvence platformunda guvenli kimlik dogrulama islemi yapin.',
  openGraph: {
    title: 'KPS Kimlik Dogrulama | Kira Güvence',
