...
const promotions = [
  {
    ...
    title: 'Ilk 3 Ay Komisyonsuz',
    description: 'Yeni kayit tesviki. Ilk 3 ay hicbir komisyon odemeyin.',
  },
  {
    icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
    title: '12. Ay Komisyonsuz',
    description: '1 yil boyunca platformu kullanin, 12. ay hediye.',
  },
  {
    icon: 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2v16z',
    title: '2. Yil Yenileme Indirimi',
    description: 'Sozlesme yenileyen kullanicilara komisyon oraninda %25 indirim.',
  },
  {
    icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z',
    title: 'Arkadasini Getir',
    description: 'Davet ettiginiz kisi kaydolsun, ikiniz de 1 ay komisyonsuz.',
  },
];
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {promotions.map((promo) => (
                ...
                >
                  ...
                  <h3 className="mt-4 text-base font-bold text-slate-900">{promo.title}</h3>
