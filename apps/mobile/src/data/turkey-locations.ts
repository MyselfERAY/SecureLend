/**
 * Turkey Provinces (İller) and Districts (İlçeler) Data
 * All 81 provinces with their real districts
 */
...
export const DISTRICTS: Record<string, string[]> = {
  ...
  'İzmir': [
    ...
    'Karabağlar', 'Karaburun', 'Karşıyaka', 'Kemalpaşa', 'Kınık', 'Kiraz', 'Konak',
    'Menderes', 'Menemen', 'Narlıdere', 'Ödemiş', 'Seferihisar', 'Selçuk', 'Tire',
    'Torbalı', 'Urla',
  ],
  'Kars': [
  ...
  'Kırıkkale': [
    'Bahşili', 'Balışeyh', 'Çelebi', 'Delice', 'Karakeçili', 'Keskin', 'Merkez',
    'Sulakyurt', 'Yahşihan',
  ],
  'Batman': [
